...
router.get('/filtrar_todo/:idLocalidad/:idCategoria/:idOperacion/:order/:moneda', (req, res) => {
    ...
    if(order == "normal"){
        db.query('SELECT ubicacion.partido, ubicacion.localidad, tipo_operacion.operacion, categorias.categoria, datos_tecnicos.*, inmuebles.* FROM inmuebles LEFT JOIN ubicacion ON inmuebles.idLocalidad = ubicacion.id LEFT JOIN datos_tecnicos ON inmuebles.id = datos_tecnicos.idCasa LEFT JOIN categorias ON inmuebles.idCategoria = categorias.id LEFT JOIN tipo_operacion ON inmuebles.idOperacion = tipo_operacion.id WHERE idLocalidad = ? AND idCategoria = ? AND idOperacion = ? AND moneda = ?', [idLocalidad, idCategoria, idOperacion, moneda], (err, rows, fields) => {
            if(! err){
                casas = [];
                rows.forEach(inmueble => {
                    casas.push(inmueble.id);
        ...
        db.query('SELECT ubicacion.partido, ubicacion.localidad, tipo_operacion.operacion, categorias.categoria, datos_tecnicos.*, inmuebles.* FROM inmuebles LEFT JOIN ubicacion ON inmuebles.idLocalidad = ubicacion.id LEFT JOIN datos_tecnicos ON inmuebles.id = datos_tecnicos.idCasa LEFT JOIN categorias ON inmuebles.idCategoria = categorias.id LEFT JOIN tipo_operacion ON inmuebles.idOperacion = tipo_operacion.id WHERE idLocalidad = ? AND idCategoria = ? AND idOperacion = ? AND moneda = ? ORDER BY precio DESC', [idLocalidad, idCategoria, idOperacion, moneda], (err, rows, fields) => {
            if(! err){
                casas = [];
                rows.forEach(inmueble => {
                    casas.push(inmueble.id);
        ...
        db.query('SELECT ubicacion.partido, ubicacion.localidad, tipo_operacion.operacion, categorias.categoria, datos_tecnicos.*, inmuebles.* FROM inmuebles LEFT JOIN ubicacion ON inmuebles.idLocalidad = ubicacion.id LEFT JOIN datos_tecnicos ON inmuebles.id = datos_tecnicos.idCasa LEFT JOIN categorias ON inmuebles.idCategoria = categorias.id LEFT JOIN tipo_operacion ON inmuebles.idOperacion = tipo_operacion.id WHERE idLocalidad = ? AND idCategoria = ? AND idOperacion = ? AND moneda = ? ORDER BY precio ASC', [idLocalidad, idCategoria, idOperacion, moneda], (err, rows, fields) => {
            if(! err){
                casas = [];
                rows.forEach(inmueble => {
                    casas.push(inmueble.id);
...
router.get('/filtrar_categoria_operacion/:idCategoria/:idOperacion/:order/:moneda', (req, res) => {
    ...
    if (order == "normal"){
        db.query('SELECT ubicacion.partido, ubicacion.localidad, tipo_operacion.operacion, categorias.categoria, datos_tecnicos.*, inmuebles.* FROM inmuebles LEFT JOIN ubicacion ON inmuebles.idLocalidad = ubicacion.id LEFT JOIN datos_tecnicos ON inmuebles.id = datos_tecnicos.idCasa LEFT JOIN categorias ON inmuebles.idCategoria = categorias.id LEFT JOIN tipo_operacion ON inmuebles.idOperacion = tipo_operacion.id WHERE idCategoria = ? AND idOperacion = ? AND moneda = ?', [idCategoria, idOperacion, moneda], (err, rows, fields) => {
            if(! err){
                casas = [];
                rows.forEach(inmueble => {
                    casas.push(inmueble.id);
        ...
        db.query('SELECT ubicacion.partido, ubicacion.localidad, tipo_operacion.operacion, categorias.categoria, datos_tecnicos.*, inmuebles.* FROM inmuebles LEFT JOIN ubicacion ON inmuebles.idLocalidad = ubicacion.id LEFT JOIN datos_tecnicos ON inmuebles.id = datos_tecnicos.idCasa LEFT JOIN categorias ON inmuebles.idCategoria = categorias.id LEFT JOIN tipo_operacion ON inmuebles.idOperacion = tipo_operacion.id WHERE idCategoria = ? AND idOperacion = ? AND moneda = ? ORDER BY precio ASC', [idCategoria, idOperacion, moneda], (err, rows, fields) => {
            if(! err){
                casas = [];
                rows.forEach(inmueble => {
                    casas.push(inmueble.id);
        ...
        db.query('SELECT ubicacion.partido, ubicacion.localidad, tipo_operacion.operacion, categorias.categoria, datos_tecnicos.*, inmuebles.* FROM inmuebles LEFT JOIN ubicacion ON inmuebles.idLocalidad = ubicacion.id LEFT JOIN datos_tecnicos ON inmuebles.id = datos_tecnicos.idCasa LEFT JOIN categorias ON inmuebles.idCategoria = categorias.id LEFT JOIN tipo_operacion ON inmuebles.idOperacion = tipo_operacion.id WHERE idCategoria = ? AND idOperacion = ? AND moneda = ? ORDER BY precio DESC', [idCategoria, idOperacion, moneda], (err, rows, fields) => {
            if(! err){
                casas = [];
                rows.forEach(inmueble => {
                    casas.push(inmueble.id);
